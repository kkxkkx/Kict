...
public class SelectableTextHelper {
    ...
    private SelectInfo mSelectionInfo = new SelectInfo();
    ...
    private void selectText(int startPos, int endPos) {
        ...
        if (mSpannable != null) {
            ...
            if (mSelectListener != null) {
                mSelectListener.onTextSelect(mSelectionInfo.mSelectionContent);
            }
        }
    }

    OnWordClickListener mNoteBookClickListener;
    public void setSelectListener(OnSelectListener selectListener) {
        mSelectListener = selectListener;
    }

    public void setOnNotesClickListener(OnWordClickListener notesClickListener) {
    ...
    private class OperateWindow {
        ...
        public OperateWindow(final Context context) {
            View contentView = LayoutInflater.from(context).inflate(R.layout.item_operator, null);
            ...
            contentView.findViewById(R.id.tv_select_search).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
